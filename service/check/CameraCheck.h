...
class CameraCheck: public V2Service {
    ...
    public:void CameraTest(string stockinfoID,string partId, string item_id,string created_by){
       ...
       if(variance!=""){
           ...
           File_updated_name= getfromERP.updateFile2ERp("Temp_Data/CameraTest.avi");      
        ...
        if( parametrmap["Camera_Variance"]==""){
            parametrmap["Camera_Blurry_Status"]="FAIL";
        }
